...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/imagenai
```

A live public deployment of this template is available at [https://imagenai.templates.workers.dev](https://imagenai.templates.workers.dev)
